...
import com.arcot.apps.callout.matchlibrary.field.NumericDoubleField;
 ...
 * */
public class LastBillAmoutField extends NumericDoubleField {

	public LastBillAmoutField(CORequest request, COConfig config, String fieldName, String userData, String storedData) {
